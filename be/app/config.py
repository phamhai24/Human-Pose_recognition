...
MODEL_PATH = Path(os.getenv('POSE_MODEL_PATH', ROOT / 'models/best_lstm_model.keras'))
LANDMARKER_PATH = Path(os.getenv('POSE_LANDMARKER_PATH', ROOT / 'models/pose_landmarker_heavy.task'))
